"""
Reinforcement Learning trading functions

This module provides the functions used by the RL Trading Manager
for reward calculation, trading, and model training.
"""
